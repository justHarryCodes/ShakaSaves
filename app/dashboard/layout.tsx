...
import {
  Home, Plus, ListOrdered, CreditCard,
  ArrowDownToLine, History, LogOut, Menu, X, MessageCircle,
} from "lucide-react";
        ...
        <div className="px-5 py-5 border-b border-white/[0.05]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-600 mt-0.5">My Savings</p>
            </div>
          </div>
        </div>
      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.05]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-bold text-white tracking-wide">Shaka Saves</h1>
              <p className="text-[10px] text-zinc-600">My Savings</p>
            </div>
          </div>
        ...
        <div className="px-5 py-3 border-b border-white/[0.05]">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-white truncate">{user.displayName ?? "Customer"}</p>
